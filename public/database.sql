...
-- MONDAY (Line by Line with Course Name)
...
-- Table 1: Course Details (Credits and Faculty)
...
-- Table 2: Weekly Grid (Monday to Friday Timetable)
...
TRUNCATE TABLE weekly_grid;

-- ==========================================
-- DATA FOR II YEAR (SHS04)
-- ==========================================
...
SELECT * FROM weekly_grid WHERE year = 2; -- 2nd year details mattum varum
SELECT * FROM weekly_grid WHERE year = 3; -- 3rd year details mattum varum
SELECT * FROM course_details; -- Course name, Faculty, L-T-P-O-C ellam varum
